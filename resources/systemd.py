...
# Modified top line from python to python3 as debian has no respect for raw python.
# Source: https://raw.githubusercontent.com/librenms/librenms-agent/master/snmp/systemd.py
